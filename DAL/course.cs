...
namespace Lythen.DAL
{
    ...
    public partial class course
    {
        ...
        /// <returns></returns>
        public DataSet GetListForTable(int subject_id, int teacher_id, string status,int school_id)
        {
            SqlParameter[] parameters = {
            ...
            parameters[3].Value = school_id;
            return DbHelperSQL.RunProcedure("proGetCourseList", parameters,"ds");
        }
        /// <summary>
        /// 选择课程的总价格
        /// </summary>
