...
namespace Lythen.DAL
{
	...
	public partial class schools
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("School_id", "schools"); 
		}
		...
		public bool DeleteList(string School_idlist )
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from schools ");
			strSql.Append(" where School_id in ("+School_idlist + ")  ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select School_id,School_name,School_address,School_contact_man,School_contact_phone,School_info ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" School_id,School_name,School_address,School_contact_man,School_contact_phone,School_info ");
			strSql.Append(" FROM schools ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			{
				strSql.Append("order by T.School_id desc");
			}
        ...
        {
            return DbHelperSQL.Query("select School_id,School_name FROM schools");
        }
