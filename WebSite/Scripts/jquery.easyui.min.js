...
},beforePageText:"第",afterPageText:"页，共 {pages} 页",displayMsg:"显示 {from} 到 {to} 行，总共 {total} 行",nav:{first:{iconCls:"pagination-first",handler:function(){
...
item.domId="_easyui_tree_"+item.id;
cc.push("<li>");
...
$.fn.validatebox.defaults={required:false,validType:null,delay:200,missingMessage:"内容不能为空.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,tipOptions:{showEvent:"none",hideEvent:"none",showDelay:0,hideDelay:0,zIndex:"",onShow:function(){
...
var t=$("<table class=\"datagrid-htable\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\"><tbody></tbody></table>").appendTo(_522);
...
rows.push(opts.finder.getRow(_580,$(this)));
});
return rows;
}
};
...
if(opts.idField){
return _584.checkedRows;
}else{
var rows=[];
opts.finder.getTr(_583,"","checked",2).each(function(){
rows.push(opts.finder.getRow(_583,$(this)));
});
return rows;
}
};
...
var _589=dc.view2.children("div.datagrid-header")._outerHeight();
var _58a=dc.body2;
var _58b=_58a.outerHeight(true)-_58a.outerHeight();
var top=tr.position().top-_589-_58b;
if(top<0){
_58a.scrollTop(_58a.scrollTop()+top);
}else{
if(top+tr._outerHeight()>_58a.height()-18){
_58a.scrollTop(_58a.scrollTop()+top+tr._outerHeight()-_58a.height()+18);
}
}
}
};
function _58c(_58d,_58e){
var _58f=$.data(_58d,"datagrid");
var opts=_58f.options;
opts.finder.getTr(_58d,_58f.highlightIndex).removeClass("datagrid-row-over");
opts.finder.getTr(_58d,_58e).addClass("datagrid-row-over");
_58f.highlightIndex=_58e;
};
function _590(_591,_592,_593){
var _594=$.data(_591,"datagrid");
var dc=_594.dc;
var opts=_594.options;
var _595=_594.selectedRows;
if(opts.singleSelect){
_596(_591);
_595.splice(0,_595.length);
}
if(!_593&&opts.checkOnSelect){
_597(_591,_592,true);
}
var row=opts.finder.getRow(_591,_592);
if(opts.idField){
_4d8(_595,opts.idField,row);
}
opts.finder.getTr(_591,_592).addClass("datagrid-row-selected");
opts.onSelect.call(_591,_592,row);
_585(_591,_592);
};
function _598(_599,_59a,_59b){
var _59c=$.data(_599,"datagrid");
var dc=_59c.dc;
var opts=_59c.options;
var _59d=$.data(_599,"datagrid").selectedRows;
if(!_59b&&opts.checkOnSelect){
_59e(_599,_59a,true);
}
opts.finder.getTr(_599,_59a).removeClass("datagrid-row-selected");
var row=opts.finder.getRow(_599,_59a);
if(opts.idField){
_4d6(_59d,opts.idField,row[opts.idField]);
}
opts.onUnselect.call(_599,_59a,row);
};
function _59f(_5a0,_5a1){
var _5a2=$.data(_5a0,"datagrid");
var opts=_5a2.options;
var rows=opts.finder.getRows(_5a0);
var _5a3=$.data(_5a0,"datagrid").selectedRows;
if(!_5a1&&opts.checkOnSelect){
_5a4(_5a0,true);
}
opts.finder.getTr(_5a0,"","allbody").addClass("datagrid-row-selected");
if(opts.idField){
for(var _5a5=0;_5a5<rows.length;_5a5++){
_4d8(_5a3,opts.idField,rows[_5a5]);
}
}
opts.onSelectAll.call(_5a0,rows);
};
function _596(_5a6,_5a7){
var _5a8=$.data(_5a6,"datagrid");
var opts=_5a8.options;
var rows=opts.finder.getRows(_5a6);
var _5a9=$.data(_5a6,"datagrid").selectedRows;
if(!_5a7&&opts.checkOnSelect){
_5aa(_5a6,true);
}
opts.finder.getTr(_5a6,"","selected").removeClass("datagrid-row-selected");
if(opts.idField){
for(var _5ab=0;_5ab<rows.length;_5ab++){
_4d6(_5a9,opts.idField,rows[_5ab][opts.idField]);
}
}
opts.onUnselectAll.call(_5a6,rows);
};
function _597(_5ac,_5ad,_5ae){
var _5af=$.data(_5ac,"datagrid");
var opts=_5af.options;
if(!_5ae&&opts.selectOnCheck){
_590(_5ac,_5ad,true);
}
var tr=opts.finder.getTr(_5ac,_5ad).addClass("datagrid-row-checked");
var ck=tr.find("div.datagrid-cell-check input[type=checkbox]");
ck._propAttr("checked",true);
tr=opts.finder.getTr(_5ac,"","checked",2);
if(tr.length==opts.finder.getRows(_5ac).length){
var dc=_5af.dc;
var _5b0=dc.header1.add(dc.header2);
_5b0.find("input[type=checkbox]")._propAttr("checked",true);
}
var row=opts.finder.getRow(_5ac,_5ad);
if(opts.idField){
_4d8(_5af.checkedRows,opts.idField,row);
}
opts.onCheck.call(_5ac,_5ad,row);
};
function _59e(_5b1,_5b2,_5b3){
var _5b4=$.data(_5b1,"datagrid");
var opts=_5b4.options;
if(!_5b3&&opts.selectOnCheck){
_598(_5b1,_5b2,true);
}
var tr=opts.finder.getTr(_5b1,_5b2).removeClass("datagrid-row-checked");
var ck=tr.find("div.datagrid-cell-check input[type=checkbox]");
ck._propAttr("checked",false);
var dc=_5b4.dc;
var _5b5=dc.header1.add(dc.header2);
_5b5.find("input[type=checkbox]")._propAttr("checked",false);
var row=opts.finder.getRow(_5b1,_5b2);
if(opts.idField){
_4d6(_5b4.checkedRows,opts.idField,row[opts.idField]);
}
opts.onUncheck.call(_5b1,_5b2,row);
};
function _5a4(_5b6,_5b7){
var _5b8=$.data(_5b6,"datagrid");
var opts=_5b8.options;
var rows=opts.finder.getRows(_5b6);
if(!_5b7&&opts.selectOnCheck){
_59f(_5b6,true);
}
var dc=_5b8.dc;
var hck=dc.header1.add(dc.header2).find("input[type=checkbox]");
var bck=opts.finder.getTr(_5b6,"","allbody").addClass("datagrid-row-checked").find("div.datagrid-cell-check input[type=checkbox]");
hck.add(bck)._propAttr("checked",true);
if(opts.idField){
for(var i=0;i<rows.length;i++){
_4d8(_5b8.checkedRows,opts.idField,rows[i]);
}
}
opts.onCheckAll.call(_5b6,rows);
};
function _5aa(_5b9,_5ba){
var _5bb=$.data(_5b9,"datagrid");
var opts=_5bb.options;
var rows=opts.finder.getRows(_5b9);
if(!_5ba&&opts.selectOnCheck){
_596(_5b9,true);
}
var dc=_5bb.dc;
var hck=dc.header1.add(dc.header2).find("input[type=checkbox]");
var bck=opts.finder.getTr(_5b9,"","checked").removeClass("datagrid-row-checked").find("div.datagrid-cell-check input[type=checkbox]");
hck.add(bck)._propAttr("checked",false);
if(opts.idField){
for(var i=0;i<rows.length;i++){
_4d6(_5bb.checkedRows,opts.idField,rows[i][opts.idField]);
}
}
opts.onUncheckAll.call(_5b9,rows);
};
function _5bc(_5bd,_5be){
var opts=$.data(_5bd,"datagrid").options;
var tr=opts.finder.getTr(_5bd,_5be);
var row=opts.finder.getRow(_5bd,_5be);
if(tr.hasClass("datagrid-row-editing")){
return;
}
if(opts.onBeforeEdit.call(_5bd,_5be,row)==false){
return;
}
...
var ed=$.data(this,"datagrid.editor");
ed.actions.setValue(ed.target,row[_5c0]);
});
_5c1(_5bd,_5be);
};
function _5c2(_5c3,_5c4,_5c5){
var opts=$.data(_5c3,"datagrid").options;
var _5c6=$.data(_5c3,"datagrid").updatedRows;
var _5c7=$.data(_5c3,"datagrid").insertedRows;
var tr=opts.finder.getTr(_5c3,_5c4);
var row=opts.finder.getRow(_5c3,_5c4);
if(!tr.hasClass("datagrid-row-editing")){
return;
}
if(!_5c5){
...
var ed=$.data(this,"datagrid.editor");
var _5cb=ed.actions.getValue(ed.target);
if(row[_5ca]!=_5cb){
row[_5ca]=_5cb;
_5c8=true;
_5c9[_5ca]=_5cb;
...
_5cc(_5c3,_5c4);
$(_5c3).datagrid("refreshRow",_5c4);
if(!_5c5){
opts.onAfterEdit.call(_5c3,_5c4,row,_5c9);
}else{
opts.onCancelEdit.call(_5c3,_5c4,row);
}
};
...
var _5d4=_5cd(_5d2,_5d3.index!=undefined?_5d3.index:_5d3.id);
for(var i=0;i<_5d4.length;i++){
if(_5d4[i].field==_5d3.field){
return _5d4[i];
}
}
return null;
};
function _5bf(_5d5,_5d6){
var opts=$.data(_5d5,"datagrid").options;
var tr=opts.finder.getTr(_5d5,_5d6);
tr.children("td").each(function(){
var cell=$(this).find("div.datagrid-cell");
var _5d7=$(this).attr("field");
var col=_52a(_5d5,_5d7);
if(col&&col.editor){
var _5d8,_5d9;
if(typeof col.editor=="string"){
_5d8=col.editor;
}else{
_5d8=col.editor.type;
_5d9=col.editor.options;
}
var _5da=opts.editors[_5d8];
if(_5da){
var _5db=cell.html();
var _5dc=cell._outerWidth();
cell.addClass("datagrid-editable");
cell._outerWidth(_5dc);
cell.html("<table border=\"0\" cellspacing=\"0\" cellpadding=\"1\"><tr><td></td></tr></table>");
cell.children("table").bind("click dblclick contextmenu",function(e){
e.stopPropagation();
});
$.data(cell[0],"datagrid.editor",{actions:_5da,target:_5da.init(cell.find("td"),_5d9),field:_5d7,type:_5d8,oldHtml:_5db});
}
}
});
_4f7(_5d5,_5d6,true);
};
function _5cc(_5dd,_5de){
...
function _5c1(_5df,_5e0){
var tr=$.data(_5df,"datagrid").options.finder.getTr(_5df,_5e0);
if(!tr.hasClass("datagrid-row-editing")){
return true;
}
...
var _5e1=tr.find(".validatebox-invalid");
return _5e1.length==0;
};
function _5e2(_5e3,_5e4){
var _5e5=$.data(_5e3,"datagrid").insertedRows;
var _5e6=$.data(_5e3,"datagrid").deletedRows;
var _5e7=$.data(_5e3,"datagrid").updatedRows;
if(!_5e4){
var rows=[];
rows=rows.concat(_5e5);
...
var data=_5eb.data;
var _5ec=_5eb.insertedRows;
var _5ed=_5eb.deletedRows;
$(_5e9).datagrid("cancelEdit",_5ea);
var row=data.rows[_5ea];
if(_4d5(_5ec,row)>=0){
_4d6(_5ec,row);
}else{
_5ed.push(row);
}
_4d6(_5eb.selectedRows,opts.idField,data.rows[_5ea][opts.idField]);
_4d6(_5eb.checkedRows,opts.idField,data.rows[_5ea][opts.idField]);
opts.view.deleteRow.call(opts.view,_5e9,_5ea);
if(opts.height=="auto"){
_4f7(_5e9);
}
$(_5e9).datagrid("getPager").pagination("refresh",{total:data.total});
};
function _5ee(_5ef,_5f0){
var data=$.data(_5ef,"datagrid").data;
var view=$.data(_5ef,"datagrid").options.view;
var _5f1=$.data(_5ef,"datagrid").insertedRows;
view.insertRow.call(view,_5ef,_5f0.index,_5f0.row);
_5f1.push(_5f0.row);
$(_5ef).datagrid("getPager").pagination("refresh",{total:data.total});
};
function _5f2(_5f3,row){
var data=$.data(_5f3,"datagrid").data;
var view=$.data(_5f3,"datagrid").options.view;
var _5f4=$.data(_5f3,"datagrid").insertedRows;
view.insertRow.call(view,_5f3,null,row);
_5f4.push(row);
$(_5f3).datagrid("getPager").pagination("refresh",{total:data.total});
};
function _5f5(_5f6){
var _5f7=$.data(_5f6,"datagrid");
var data=_5f7.data;
var rows=data.rows;
var _5f8=[];
for(var i=0;i<rows.length;i++){
_5f8.push($.extend({},rows[i]));
}
_5f7.originalRows=_5f8;
_5f7.updatedRows=[];
_5f7.insertedRows=[];
_5f7.deletedRows=[];
};
...
var _5fe=_5fd.originalRows;
var _5ff=_5fd.insertedRows;
var _600=_5fd.deletedRows;
var _601=_5fd.selectedRows;
var _602=_5fd.checkedRows;
var data=_5fd.data;
function _603(a){
var ids=[];
for(var i=0;i<a.length;i++){
...
function _604(ids,_605){
for(var i=0;i<ids.length;i++){
var _606=_57c(_5fc,ids[i]);
if(_606>=0){
(_605=="s"?_590:_597)(_5fc,_606,true);
}
}
};
for(var i=0;i<data.rows.length;i++){
...
data.total+=_600.length-_5ff.length;
data.rows=_5fe;
_572(_5fc,data);
_604(_607,"s");
_604(_608,"c");
...
if(opts.onBeforeLoad.call(_60a,_60c)==false){
return;
}
$(_60a).datagrid("loading");
setTimeout(function(){
_60d();
},0);
function _60d(){
var _60e=opts.loader.call(_60a,_60c,function(data){
setTimeout(function(){
$(_60a).datagrid("loaded");
},0);
_572(_60a,data);
setTimeout(function(){
_5f5(_60a);
...
opts.onLoadError.apply(_60a,arguments);
});
if(_60e==false){
$(_60a).datagrid("loaded");
}
...
_611.rowspan=_611.rowspan||1;
_611.colspan=_611.colspan||1;
if(_611.rowspan==1&&_611.colspan==1){
return;
}
var tr=opts.finder.getTr(_610,(_611.index!=undefined?_611.index:_611.id));
if(!tr.length){
return;
}
var row=opts.finder.getRow(_610,tr);
var _612=row[_611.field];
var td=tr.find("td[field=\""+_611.field+"\"]");
td.attr("rowspan",_611.rowspan).attr("colspan",_611.colspan);
td.addClass("datagrid-td-merged");
for(var i=1;i<_611.colspan;i++){
td=td.next();
td.hide();
row[td.attr("field")]=_612;
}
for(var i=1;i<_611.rowspan;i++){
tr=tr.next();
if(!tr.length){
break;
}
var row=opts.finder.getRow(_610,tr);
var td=tr.find("td[field=\""+_611.field+"\"]").hide();
row[td.attr("field")]=_612;
for(var j=1;j<_611.colspan;j++){
td=td.next();
td.hide();
row[td.attr("field")]=_612;
}
...
$.fn.datagrid=function(_613,_614){
if(typeof _613=="string"){
return $.fn.datagrid.methods[_613](this,_614);
}
_613=_613||{};
return this.each(function(){
var _615=$.data(this,"datagrid");
var opts;
if(_615){
opts=$.extend(_615.options,_613);
_615.options=opts;
}else{
opts=$.extend({},$.extend({},$.fn.datagrid.defaults,{queryParams:{}}),$.fn.datagrid.parseOptions(this),_613);
$(this).css("width","").css("height","");
var _616=_50b(this,opts.rownumbers);
if(!opts.columns){
opts.columns=_616.columns;
}
if(!opts.frozenColumns){
opts.frozenColumns=_616.frozenColumns;
}
opts.columns=$.extend(true,[],opts.columns);
opts.frozenColumns=$.extend(true,[],opts.frozenColumns);
opts.view=$.extend({},opts.view);
$.data(this,"datagrid",{options:opts,panel:_616.panel,dc:_616.dc,ss:_616.ss,selectedRows:[],checkedRows:[],data:{total:0,rows:[]},originalRows:[],updatedRows:[],insertedRows:[],deletedRows:[]});
}
_517(this);
if(opts.data){
_572(this,opts.data);
...
var _617={text:{init:function(_618,_619){
...
$(_61e)._outerWidth(_61f)._outerHeight(22);
}},textarea:{init:function(_620,_621){
var _622=$("<textarea class=\"datagrid-editable-input\"></textarea>").appendTo(_620);
return _622;
},getValue:function(_623){
return $(_623).val();
},setValue:function(_624,_625){
$(_624).val(_625);
},resize:function(_626,_627){
$(_626)._outerWidth(_627);
}},checkbox:{init:function(_628,_629){
var _62a=$("<input type=\"checkbox\">").appendTo(_628);
_62a.val(_629.on);
_62a.attr("offval",_629.off);
return _62a;
},getValue:function(_62b){
if($(_62b).is(":checked")){
return $(_62b).val();
}else{
return $(_62b).attr("offval");
}
...
$(_62c)._propAttr("checked",_62e);
}},numberbox:{init:function(_62f,_630){
var _631=$("<input type=\"text\" class=\"datagrid-editable-input\">").appendTo(_62f);
_631.numberbox(_630);
return _631;
},destroy:function(_632){
$(_632).numberbox("destroy");
},getValue:function(_633){
$(_633).blur();
return $(_633).numberbox("getValue");
},setValue:function(_634,_635){
$(_634).numberbox("setValue",_635);
},resize:function(_636,_637){
$(_636)._outerWidth(_637)._outerHeight(22);
}},validatebox:{init:function(_638,_639){
var _63a=$("<input type=\"text\" class=\"datagrid-editable-input\">").appendTo(_638);
_63a.validatebox(_639);
return _63a;
},destroy:function(_63b){
$(_63b).validatebox("destroy");
...
}},datebox:{init:function(_641,_642){
var _643=$("<input type=\"text\">").appendTo(_641);
_643.datebox(_642);
return _643;
},destroy:function(_644){
$(_644).datebox("destroy");
},getValue:function(_645){
return $(_645).datebox("getValue");
},setValue:function(_646,_647){
$(_646).datebox("setValue",_647);
},resize:function(_648,_649){
$(_648).datebox("resize",_649);
}},combobox:{init:function(_64a,_64b){
var _64c=$("<input type=\"text\">").appendTo(_64a);
_64c.combobox(_64b||{});
return _64c;
},destroy:function(_64d){
$(_64d).combobox("destroy");
},getValue:function(_64e){
var opts=$(_64e).combobox("options");
if(opts.multiple){
return $(_64e).combobox("getValues").join(opts.separator);
}else{
return $(_64e).combobox("getValue");
}
},setValue:function(_64f,_650){
var opts=$(_64f).combobox("options");
if(opts.multiple){
if(_650){
$(_64f).combobox("setValues",_650.split(opts.separator));
}else{
$(_64f).combobox("clear");
}
}else{
$(_64f).combobox("setValue",_650);
}
},resize:function(_651,_652){
$(_651).combobox("resize",_652);
}},combotree:{init:function(_653,_654){
var _655=$("<input type=\"text\">").appendTo(_653);
_655.combotree(_654);
return _655;
},destroy:function(_656){
$(_656).combotree("destroy");
},getValue:function(_657){
return $(_657).combotree("getValue");
},setValue:function(_658,_659){
$(_658).combotree("setValue",_659);
},resize:function(_65a,_65b){
$(_65a).combotree("resize",_65b);
}}};
$.fn.datagrid.methods={options:function(jq){
var _65c=$.data(jq[0],"datagrid").options;
var _65d=$.data(jq[0],"datagrid").panel.panel("options");
var opts=$.extend(_65c,{width:_65d.width,height:_65d.height,closed:_65d.closed,collapsed:_65d.collapsed,minimized:_65d.minimized,maximized:_65d.maximized});
return opts;
},getPanel:function(jq){
return $.data(jq[0],"datagrid").panel;
},getPager:function(jq){
return $.data(jq[0],"datagrid").panel.children("div.datagrid-pager");
},getColumnFields:function(jq,_65e){
return _529(jq[0],_65e);
},getColumnOption:function(jq,_65f){
return _52a(jq[0],_65f);
},resize:function(jq,_660){
return jq.each(function(){
_4e6(this,_660);
});
},load:function(jq,_661){
return jq.each(function(){
var opts=$(this).datagrid("options");
opts.pageNumber=1;
var _662=$(this).datagrid("getPager");
_662.pagination("refresh",{pageNumber:1});
_609(this,_661);
});
},reload:function(jq,_663){
return jq.each(function(){
_609(this,_663);
});
},reloadFooter:function(jq,_664){
return jq.each(function(){
var opts=$.data(this,"datagrid").options;
var dc=$.data(this,"datagrid").dc;
if(_664){
$.data(this,"datagrid").footer=_664;
}
if(opts.showFooter){
...
if(opts.loadMsg){
var _665=$(this).datagrid("getPanel");
if(!_665.children("div.datagrid-mask").length){
$("<div class=\"datagrid-mask\" style=\"display:block\"></div>").appendTo(_665);
var msg=$("<div class=\"datagrid-mask-msg\" style=\"display:block;left:50%\"></div>").html(opts.loadMsg).appendTo(_665);
msg._outerHeight(40);
...
_666.children("div.datagrid-mask-msg").remove();
_666.children("div.datagrid-mask").remove();
});
},fitColumns:function(jq){
return jq.each(function(){
_543(this);
});
},fixColumnSize:function(jq,_667){
return jq.each(function(){
_513(this,_667);
});
},fixRowHeight:function(jq,_668){
return jq.each(function(){
_4f7(this,_668);
});
},freezeRow:function(jq,_669){
return jq.each(function(){
_504(this,_669);
});
},autoSizeColumn:function(jq,_66a){
return jq.each(function(){
_550(this,_66a);
});
},loadData:function(jq,data){
...
return jq.each(function(){
var _66b=$.data(this,"datagrid").selectedRows;
_66b.splice(0,_66b.length);
_596(this);
});
},clearChecked:function(jq){
return jq.each(function(){
var _66c=$.data(this,"datagrid").checkedRows;
_66c.splice(0,_66c.length);
_5aa(this);
});
},scrollTo:function(jq,_66d){
return jq.each(function(){
_585(this,_66d);
});
},highlightRow:function(jq,_66e){
return jq.each(function(){
_58c(this,_66e);
_585(this,_66e);
});
...
var opts=$.data(this,"datagrid").options;
if(opts.idField){
var _670=_57c(this,id);
if(_670>=0){
$(this).datagrid("selectRow",_670);
}
}
});
},unselectRow:function(jq,_671){
return jq.each(function(){
_598(this,_671);
});
},checkRow:function(jq,_672){
return jq.each(function(){
_597(this,_672);
});
},uncheckRow:function(jq,_673){
return jq.each(function(){
_59e(this,_673);
});
...
},beginEdit:function(jq,_674){
return jq.each(function(){
_5bc(this,_674);
});
},endEdit:function(jq,_675){
return jq.each(function(){
_5c2(this,_675,false);
});
},cancelEdit:function(jq,_676){
return jq.each(function(){
_5c2(this,_676,true);
});
},getEditors:function(jq,_677){
return _5cd(jq[0],_677);
},getEditor:function(jq,_678){
return _5d1(jq[0],_678);
},refreshRow:function(jq,_679){
return jq.each(function(){
var opts=$.data(this,"datagrid").options;
opts.view.refreshRow.call(opts.view,this,_679);
});
},validateRow:function(jq,_67a){
return _5c1(jq[0],_67a);
},updateRow:function(jq,_67b){
return jq.each(function(){
var opts=$.data(this,"datagrid").options;
opts.view.updateRow.call(opts.view,this,_67b.index,_67b.row);
});
},appendRow:function(jq,row){
return jq.each(function(){
_5f2(this,row);
});
},insertRow:function(jq,_67c){
return jq.each(function(){
_5ee(this,_67c);
});
},deleteRow:function(jq,_67d){
return jq.each(function(){
_5e8(this,_67d);
});
},getChanges:function(jq,_67e){
return _5e2(jq[0],_67e);
...
},mergeCells:function(jq,_67f){
return jq.each(function(){
_60f(this,_67f);
});
},showColumn:function(jq,_680){
return jq.each(function(){
var _681=$(this).datagrid("getPanel");
_681.find("td[field=\""+_680+"\"]").show();
$(this).datagrid("getColumnOption",_680).hidden=false;
$(this).datagrid("fitColumns");
});
},hideColumn:function(jq,_682){
return jq.each(function(){
var _683=$(this).datagrid("getPanel");
_683.find("td[field=\""+_682+"\"]").hide();
$(this).datagrid("getColumnOption",_682).hidden=true;
$(this).datagrid("fitColumns");
});
}};
$.fn.datagrid.parseOptions=function(_684){
var t=$(_684);
return $.extend({},$.fn.panel.parseOptions(_684),$.parser.parseOptions(_684,["url","toolbar","idField","sortName","sortOrder","pagePosition","resizeHandle",{fitColumns:"boolean",autoRowHeight:"boolean",striped:"boolean",nowrap:"boolean"},{rownumbers:"boolean",singleSelect:"boolean",checkOnSelect:"boolean",selectOnCheck:"boolean"},{pagination:"boolean",pageSize:"number",pageNumber:"number"},{multiSort:"boolean",remoteSort:"boolean",showHeader:"boolean",showFooter:"boolean"},{scrollbarSize:"number"}]),{pageList:(t.attr("pageList")?eval(t.attr("pageList")):undefined),loadMsg:(t.attr("loadMsg")!=undefined?t.attr("loadMsg"):undefined),rowStyler:(t.attr("rowStyler")?eval(t.attr("rowStyler")):undefined)});
};
$.fn.datagrid.parseData=function(_685){
var t=$(_685);
var data={total:0,rows:[]};
var _686=t.datagrid("getColumnFields",true).concat(t.datagrid("getColumnFields",false));
t.find("tbody tr").each(function(){
data.total++;
var row={};
$.extend(row,$.parser.parseOptions(this,["iconCls","state"]));
for(var i=0;i<_686.length;i++){
row[_686[i]]=$(this).find("td:eq("+i+")").html();
}
data.rows.push(row);
});
return data;
};
var _687={render:function(_688,_689,_68a){
var _68b=$.data(_688,"datagrid");
var opts=_68b.options;
var rows=_68b.data.rows;
var _68c=$(_688).datagrid("getColumnFields",_68a);
if(_68a){
if(!(opts.rownumbers||(opts.frozenColumns&&opts.frozenColumns.length))){
return;
}
}
var _68d=["<table class=\"datagrid-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" width=\"100%\"><tbody>"];
for(var i=0;i<rows.length;i++){
var css=opts.rowStyler?opts.rowStyler.call(_688,i,rows[i]):"";
var _68e="";
var _68f="";
...
var cls="class=\"datagrid-row "+(i%2&&opts.striped?"datagrid-row-alt ":" ")+_68e+"\"";
var _690=_68f?"style=\""+_68f+"\"":"";
var _691=_68b.rowIdPrefix+"-"+(_68a?1:2)+"-"+i;
_68d.push("<tr id=\""+_691+"\" datagrid-row-index=\""+i+"\" "+cls+" "+_690+">");
_68d.push(this.renderRow.call(this,_688,_68c,_68a,i,rows[i]));
_68d.push("</tr>");
}
_68d.push("</tbody></table>");
$(_689).html(_68d.join(""));
},renderFooter:function(_692,_693,_694){
var opts=$.data(_692,"datagrid").options;
var rows=$.data(_692,"datagrid").footer||[];
var _695=$(_692).datagrid("getColumnFields",_694);
var _696=["<table class=\"datagrid-ftable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
_696.push("<tr class=\"datagrid-row\" datagrid-row-index=\""+i+"\">");
_696.push(this.renderRow.call(this,_692,_695,_694,i,rows[i]));
_696.push("</tr>");
}
_696.push("</tbody></table>");
$(_693).html(_696.join(""));
},renderRow:function(_697,_698,_699,_69a,_69b){
var opts=$.data(_697,"datagrid").options;
var cc=[];
if(_699&&opts.rownumbers){
var _69c=_69a+1;
if(opts.pagination){
_69c+=(opts.pageNumber-1)*opts.pageSize;
}
cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">"+_69c+"</div></td>");
}
for(var i=0;i<_698.length;i++){
var _69d=_698[i];
var col=$(_697).datagrid("getColumnOption",_69d);
if(col){
var _69e=_69b[_69d];
var css=col.styler?(col.styler(_69e,_69b,_69a)||""):"";
var _69f="";
var _6a0="";
if(typeof css=="string"){
_6a0=css;
...
var cls=_69f?"class=\""+_69f+"\"":"";
var _6a1=col.hidden?"style=\"display:none;"+_6a0+"\"":(_6a0?"style=\""+_6a0+"\"":"");
cc.push("<td field=\""+_69d+"\" "+cls+" "+_6a1+">");
if(col.checkbox){
var _6a1="";
}else{
var _6a1=_6a0;
if(col.align){
_6a1+=";text-align:"+col.align+";";
}
if(!opts.nowrap){
_6a1+=";white-space:normal;height:auto;";
}else{
...
cc.push("<div style=\""+_6a1+"\" ");
cc.push(col.checkbox?"class=\"datagrid-cell-check\"":"class=\"datagrid-cell "+col.cellClass+"\"");
cc.push(">");
if(col.checkbox){
cc.push("<input type=\"checkbox\" name=\""+_69d+"\" value=\""+(_69e!=undefined?_69e:"")+"\">");
}else{
if(col.formatter){
cc.push(col.formatter(_69e,_69b,_69a));
}else{
cc.push(_69e);
}
}
...
return cc.join("");
},refreshRow:function(_6a2,_6a3){
this.updateRow.call(this,_6a2,_6a3,{});
},updateRow:function(_6a4,_6a5,row){
var opts=$.data(_6a4,"datagrid").options;
var rows=$(_6a4).datagrid("getRows");
$.extend(rows[_6a5],row);
var css=opts.rowStyler?opts.rowStyler.call(_6a4,_6a5,rows[_6a5]):"";
var _6a6="";
var _6a7="";
if(typeof css=="string"){
_6a7=css;
...
var _6a6="datagrid-row "+(_6a5%2&&opts.striped?"datagrid-row-alt ":" ")+_6a6;
function _6a8(_6a9){
var _6aa=$(_6a4).datagrid("getColumnFields",_6a9);
var tr=opts.finder.getTr(_6a4,_6a5,"body",(_6a9?1:2));
var _6ab=tr.find("div.datagrid-cell-check input[type=checkbox]").is(":checked");
tr.html(this.renderRow.call(this,_6a4,_6aa,_6a9,_6a5,rows[_6a5]));
tr.attr("style",_6a7).attr("class",tr.hasClass("datagrid-row-selected")?_6a6+" datagrid-row-selected":_6a6);
if(_6ab){
tr.find("div.datagrid-cell-check input[type=checkbox]")._propAttr("checked",true);
}
};
_6a8.call(this,true);
_6a8.call(this,false);
$(_6a4).datagrid("fixRowHeight",_6a5);
},insertRow:function(_6ac,_6ad,row){
var _6ae=$.data(_6ac,"datagrid");
var opts=_6ae.options;
var dc=_6ae.dc;
var data=_6ae.data;
if(_6ad==undefined||_6ad==null){
_6ad=data.rows.length;
}
if(_6ad>data.rows.length){
_6ad=data.rows.length;
}
function _6af(_6b0){
var _6b1=_6b0?1:2;
for(var i=data.rows.length-1;i>=_6ad;i--){
var tr=opts.finder.getTr(_6ac,i,"body",_6b1);
tr.attr("datagrid-row-index",i+1);
tr.attr("id",_6ae.rowIdPrefix+"-"+_6b1+"-"+(i+1));
if(_6b0&&opts.rownumbers){
var _6b2=i+2;
if(opts.pagination){
_6b2+=(opts.pageNumber-1)*opts.pageSize;
}
tr.find("div.datagrid-cell-rownumber").html(_6b2);
}
if(opts.striped){
...
function _6b3(_6b4){
var _6b5=_6b4?1:2;
var _6b6=$(_6ac).datagrid("getColumnFields",_6b4);
var _6b7=_6ae.rowIdPrefix+"-"+_6b5+"-"+_6ad;
var tr="<tr id=\""+_6b7+"\" class=\"datagrid-row\" datagrid-row-index=\""+_6ad+"\"></tr>";
if(_6ad>=data.rows.length){
if(data.rows.length){
opts.finder.getTr(_6ac,"","last",_6b5).after(tr);
}else{
var cc=_6b4?dc.body1:dc.body2;
cc.html("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"+tr+"</tbody></table>");
}
}else{
opts.finder.getTr(_6ac,_6ad+1,"body",_6b5).before(tr);
}
};
_6af.call(this,true);
_6af.call(this,false);
_6b3.call(this,true);
_6b3.call(this,false);
data.total+=1;
data.rows.splice(_6ad,0,row);
this.refreshRow.call(this,_6ac,_6ad);
},deleteRow:function(_6b8,_6b9){
var _6ba=$.data(_6b8,"datagrid");
var opts=_6ba.options;
var data=_6ba.data;
function _6bb(_6bc){
var _6bd=_6bc?1:2;
for(var i=_6b9+1;i<data.rows.length;i++){
var tr=opts.finder.getTr(_6b8,i,"body",_6bd);
tr.attr("datagrid-row-index",i-1);
tr.attr("id",_6ba.rowIdPrefix+"-"+_6bd+"-"+(i-1));
if(_6bc&&opts.rownumbers){
var _6be=i;
if(opts.pagination){
_6be+=(opts.pageNumber-1)*opts.pageSize;
}
tr.find("div.datagrid-cell-rownumber").html(_6be);
}
if(opts.striped){
tr.removeClass("datagrid-row-alt").addClass((i-1)%2?"datagrid-row-alt":"");
}
...
opts.finder.getTr(_6b8,_6b9).remove();
_6bb.call(this,true);
_6bb.call(this,false);
data.total-=1;
data.rows.splice(_6b9,1);
},onBeforeRender:function(_6bf,rows){
},onAfterRender:function(_6c0){
var opts=$.data(_6c0,"datagrid").options;
if(opts.showFooter){
var _6c1=$(_6c0).datagrid("getPanel").find("div.datagrid-footer");
_6c1.find("div.datagrid-cell-rownumber,div.datagrid-cell-check").css("visibility","hidden");
}
}};
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Processing, please wait ...",rownumbers:false,singleSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_6c2,_6c3){
},loader:function(_6c4,_6c5,_6c6){
var opts=$(this).datagrid("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_6c4,dataType:"json",success:function(data){
try{
 if(data.rows[0].error=="nologin"){
	alert("没有登陆或登陆超时，请重新登陆。");
	top.location.href="login.html";
...
},editors:_617,finder:{getTr:function(_6c7,_6c8,type,_6c9){
type=type||"body";
_6c9=_6c9||0;
...
if(_6c9==0){
var tr1=opts.finder.getTr(_6c7,_6c8,type,1);
var tr2=opts.finder.getTr(_6c7,_6c8,type,2);
return tr1.add(tr2);
}else{
if(type=="body"){
var tr=$("#"+_6ca.rowIdPrefix+"-"+_6c9+"-"+_6c8);
if(!tr.length){
tr=(_6c9==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-index="+_6c8+"]");
}
return tr;
}else{
if(type=="footer"){
return (_6c9==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-index="+_6c8+"]");
}else{
if(type=="selected"){
return (_6c9==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row-selected");
}else{
if(type=="highlight"){
return (_6c9==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row-over");
}else{
if(type=="checked"){
return (_6c9==1?dc.body1:dc.body2).find(">table>tbody>tr.datagrid-row-checked");
}else{
if(type=="last"){
return (_6c9==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-index]:last");
}else{
if(type=="allbody"){
return (_6c9==1?dc.body1:dc.body2).find(">table>tbody>tr[datagrid-row-index]");
}else{
if(type=="allfooter"){
return (_6c9==1?dc.footer1:dc.footer2).find(">table>tbody>tr[datagrid-row-index]");
}
}
}
}
...
},getRow:function(_6cb,p){
var _6cc=(typeof p=="object")?p.attr("datagrid-row-index"):p;
return $.data(_6cb,"datagrid").data.rows[parseInt(_6cc)];
},getRows:function(_6cd){
return $(_6cd).datagrid("getRows");
}},view:_687,onBeforeLoad:function(_6ce){
...
var view=$(_773).datagrid("getPanel").children("div.datagrid-view");
var node=view.find("div.datagrid-body tr[node-id=\""+_774+"\"]").children("td[field=\""+opts.treeField+"\"]");
return node.find("span.tree-indent,span.tree-hit").length;
};
function find(_775,_776){
var opts=$.data(_775,"treegrid").options;
var data=$.data(_775,"treegrid").data;
var cc=[data];
while(cc.length){
var c=cc.shift();
for(var i=0;i<c.length;i++){
var node=c[i];
if(node[opts.idField]==_776){
return node;
}else{
if(node["children"]){
...
if(opts.onBeforeCollapse.call(_778,row)==false){
return;
}
hit.removeClass("tree-expanded tree-expanded-hover").addClass("tree-collapsed");
hit.next().removeClass("tree-folder-open");
...
$(_778).treegrid("autoSizeColumn");
_73d(_778,_779);
opts.onCollapse.call(_778,row);
});
}else{
cc.hide();
$(_778).treegrid("autoSizeColumn");
...
if(opts.onBeforeExpand.call(_77b,row)==false){
return;
}
hit.removeClass("tree-collapsed tree-collapsed-hover").addClass("tree-expanded");
hit.next().addClass("tree-folder-open");
var _77d=tr.next("tr.treegrid-tr-tree");
if(_77d.length){
var cc=_77d.children("td").children("div");
_77e(cc);
}else{
_74b(_77b,row[opts.idField]);
var _77d=tr.next("tr.treegrid-tr-tree");
var cc=_77d.children("td").children("div");
cc.hide();
var _77f=$.extend({},opts.queryParams||{});
_77f.id=row[opts.idField];
_73c(_77b,row[opts.idField],_77f,true,function(){
if(cc.is(":empty")){
_77d.remove();
}else{
_77e(cc);
...
$(_77b).treegrid("autoSizeColumn");
_73d(_77b,_77c);
opts.onExpand.call(_77b,row);
});
}else{
cc.show();
$(_77b).treegrid("autoSizeColumn");
...
var opts=$.data(_783,"treegrid").options;
var _785=_741(_783,_784);
if(_784){
_785.unshift(find(_783,_784));
}
for(var i=0;i<_785.length;i++){
_777(_783,_785[i][opts.idField]);
}
};
function _786(_787,_788){
var opts=$.data(_787,"treegrid").options;
var _789=_741(_787,_788);
if(_788){
_789.unshift(find(_787,_788));
}
for(var i=0;i<_789.length;i++){
_77a(_787,_789[i][opts.idField]);
}
};
function _78a(_78b,_78c){
var opts=$.data(_78b,"treegrid").options;
var ids=[];
var p=_767(_78b,_78c);
while(p){
...
if(_78f.parent){
var tr=opts.finder.getTr(_78e,_78f.parent);
if(tr.next("tr.treegrid-tr-tree").length==0){
_74b(_78e,_78f.parent);
}
var cell=tr.children("td[field=\""+opts.treeField+"\"]").children("div.datagrid-cell");
var _790=cell.children("span.tree-icon");
if(_790.hasClass("tree-file")){
_790.removeClass("tree-file").addClass("tree-folder tree-folder-open");
var hit=$("<span class=\"tree-hit tree-expanded\"></span>").insertBefore(_790);
if(hit.prev().length){
hit.prev().remove();
}
}
}
_752(_78e,_78f.parent,_78f.data,true);
};
function _791(_792,_793){
var ref=_793.before||_793.after;
var opts=$.data(_792,"treegrid").options;
var _794=_767(_792,ref);
_78d(_792,{parent:(_794?_794[opts.idField]:null),data:[_793.data]});
_795(true);
_795(false);
_745(_792);
function _795(_796){
var _797=_796?1:2;
var tr=opts.finder.getTr(_792,_793.data[opts.idField],"body",_797);
var _798=tr.closest("table.datagrid-btable");
tr=tr.parent().children();
var dest=opts.finder.getTr(_792,ref,"body",_797);
if(_793.before){
...
var _79c=del(_79b);
if(_79c){
if(_79c.children.length==0){
tr=opts.finder.getTr(_79a,_79c[opts.idField]);
tr.next("tr.treegrid-tr-tree").remove();
var cell=tr.children("td[field=\""+opts.treeField+"\"]").children("div.datagrid-cell");
...
function del(id){
var cc;
var _79d=_767(_79a,_79b);
if(_79d){
cc=_79d.children;
}else{
cc=$(_79a).treegrid("getData");
}
for(var i=0;i<cc.length;i++){
...
$.fn.treegrid=function(_79e,_79f){
if(typeof _79e=="string"){
var _7a0=$.fn.treegrid.methods[_79e];
if(_7a0){
return _7a0(this,_79f);
}else{
return this.datagrid(_79e,_79f);
}
}
_79e=_79e||{};
return this.each(function(){
var _7a1=$.data(this,"treegrid");
if(_7a1){
$.extend(_7a1.options,_79e);
}else{
_7a1=$.data(this,"treegrid",{options:$.extend({},$.fn.treegrid.defaults,$.fn.treegrid.parseOptions(this),_79e),data:[]});
}
_723(this);
if(_7a1.options.data){
$(this).treegrid("loadData",_7a1.options.data);
}
_73c(this);
_747(this);
});
...
},resize:function(jq,_7a2){
return jq.each(function(){
$(this).datagrid("resize",_7a2);
});
},fixRowHeight:function(jq,_7a3){
return jq.each(function(){
_73d(this,_7a3);
});
},loadData:function(jq,data){
...
},load:function(jq,_7a4){
return jq.each(function(){
$(this).treegrid("options").pageNumber=1;
$(this).treegrid("getPager").pagination({pageNumber:1});
$(this).treegrid("reload",_7a4);
});
...
_7a5=$.extend({},opts.queryParams);
_7a5.id=id;
}
if(_7a5.id){
var node=$(this).treegrid("find",_7a5.id);
if(node.children){
node.children.splice(0,node.children.length);
}
opts.queryParams=_7a5;
var tr=opts.finder.getTr(this,_7a5.id);
tr.next("tr.treegrid-tr-tree").remove();
...
},reloadFooter:function(jq,_7a6){
return jq.each(function(){
var opts=$.data(this,"treegrid").options;
var dc=$.data(this,"datagrid").dc;
if(_7a6){
$.data(this,"treegrid").footer=_7a6;
}
if(opts.showFooter){
opts.view.renderFooter.call(opts.view,this,dc.footer1,true);
opts.view.renderFooter.call(opts.view,this,dc.footer2,false);
...
},append:function(jq,_7a7){
return jq.each(function(){
_78d(this,_7a7);
});
},insert:function(jq,_7a8){
return jq.each(function(){
_791(this,_7a8);
});
...
},update:function(jq,_7a9){
return jq.each(function(){
var opts=$.data(this,"treegrid").options;
opts.view.updateRow.call(opts.view,this,_7a9.id,_7a9.row);
});
...
$.fn.treegrid.parseOptions=function(_7aa){
return $.extend({},$.fn.datagrid.parseOptions(_7aa),$.parser.parseOptions(_7aa,["treeField",{animate:"boolean"}]));
};
var _7ab=$.extend({},$.fn.datagrid.defaults.view,{render:function(_7ac,_7ad,_7ae){
var opts=$.data(_7ac,"treegrid").options;
var _7af=$(_7ac).datagrid("getColumnFields",_7ae);
var _7b0=$.data(_7ac,"datagrid").rowIdPrefix;
if(_7ae){
if(!(opts.rownumbers||(opts.frozenColumns&&opts.frozenColumns.length))){
return;
}
...
var _7b1=0;
var view=this;
var _7b2=_7b3(_7ae,this.treeLevel,this.treeNodes);
$(_7ad).append(_7b2.join(""));
function _7b3(_7b4,_7b5,_7b6){
...
var css=opts.rowStyler?opts.rowStyler.call(_7ac,row):"";
var _7b8="";
var _7b9="";
if(typeof css=="string"){
_7b9=css;
...
var cls="class=\"datagrid-row "+(_7b1++%2&&opts.striped?"datagrid-row-alt ":" ")+_7b8+"\"";
var _7ba=_7b9?"style=\""+_7b9+"\"":"";
var _7bb=_7b0+"-"+(_7b4?1:2)+"-"+row[opts.idField];
_7b7.push("<tr id=\""+_7bb+"\" node-id=\""+row[opts.idField]+"\" "+cls+" "+_7ba+">");
_7b7=_7b7.concat(view.renderRow.call(view,_7ac,_7af,_7b4,_7b5,row));
_7b7.push("</tr>");
if(row.children&&row.children.length){
var tt=_7b3(_7b4,_7b5+1,row.children);
var v=row.state=="closed"?"none":"block";
_7b7.push("<tr class=\"treegrid-tr-tree\"><td style=\"border:0px\" colspan="+(_7af.length+(opts.rownumbers?1:0))+"><div style=\"display:"+v+"\">");
_7b7=_7b7.concat(tt);
_7b7.push("</div></td></tr>");
}
}
...
},renderFooter:function(_7bc,_7bd,_7be){
var opts=$.data(_7bc,"treegrid").options;
var rows=$.data(_7bc,"treegrid").footer||[];
var _7bf=$(_7bc).datagrid("getColumnFields",_7be);
var _7c0=["<table class=\"datagrid-ftable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
var row=rows[i];
row[opts.idField]=row[opts.idField]||("foot-row-id"+i);
_7c0.push("<tr class=\"datagrid-row\" node-id=\""+row[opts.idField]+"\">");
_7c0.push(this.renderRow.call(this,_7bc,_7bf,_7be,0,row));
_7c0.push("</tr>");
}
_7c0.push("</tbody></table>");
$(_7bd).html(_7c0.join(""));
},renderRow:function(_7c1,_7c2,_7c3,_7c4,row){
...
var _7c5=_7c2[i];
var col=$(_7c1).datagrid("getColumnOption",_7c5);
if(col){
var css=col.styler?(col.styler(row[_7c5],row)||""):"";
var _7c6="";
var _7c7="";
if(typeof css=="string"){
_7c7=css;
...
var cls=_7c6?"class=\""+_7c6+"\"":"";
var _7c8=col.hidden?"style=\"display:none;"+_7c7+"\"":(_7c7?"style=\""+_7c7+"\"":"");
cc.push("<td field=\""+_7c5+"\" "+cls+" "+_7c8+">");
if(col.checkbox){
var _7c8="";
}else{
var _7c8=_7c7;
if(col.align){
_7c8+=";text-align:"+col.align+";";
}
if(!opts.nowrap){
_7c8+=";white-space:normal;height:auto;";
}else{
if(opts.autoRowHeight){
_7c8+=";height:auto;";
}
...
cc.push(" name=\""+_7c5+"\" value=\""+(row[_7c5]!=undefined?row[_7c5]:"")+"\"/>");
}else{
var val=null;
if(col.formatter){
val=col.formatter(row[_7c5],row);
}else{
val=row[_7c5];
}
if(_7c5==opts.treeField){
for(var j=0;j<_7c4;j++){
cc.push("<span class=\"tree-indent\"></span>");
}
if(row.state=="closed"){
cc.push("<span class=\"tree-hit tree-collapsed\"></span>");
...
return cc.join("");
},refreshRow:function(_7c9,id){
this.updateRow.call(this,_7c9,id,{});
},updateRow:function(_7ca,id,row){
var opts=$.data(_7ca,"treegrid").options;
var _7cb=$(_7ca).treegrid("find",id);
$.extend(_7cb,row);
var _7cc=$(_7ca).treegrid("getLevel",id)-1;
var _7cd=opts.rowStyler?opts.rowStyler.call(_7ca,_7cb):"";
function _7ce(_7cf){
var _7d0=$(_7ca).treegrid("getColumnFields",_7cf);
var tr=opts.finder.getTr(_7ca,id,"body",(_7cf?1:2));
var _7d1=tr.find("div.datagrid-cell-rownumber").html();
var _7d2=tr.find("div.datagrid-cell-check input[type=checkbox]").is(":checked");
tr.html(this.renderRow(_7ca,_7d0,_7cf,_7cc,_7cb));
tr.attr("style",_7cd||"");
...
$(_7ca).treegrid("fixRowHeight",id);
},onBeforeRender:function(_7d3,_7d4,data){
if($.isArray(_7d4)){
data={total:_7d4.length,rows:_7d4};
_7d4=null;
}
if(!data){
return false;
}
var _7d5=$.data(_7d3,"treegrid");
...
if(data.total){
_7d5.total=data.total;
}
data=this.transfer(_7d3,_7d4,data.rows);
}else{
...
row._parentId=_7d8;
if(row.children&&row.children.length){
_7d6(row.children,row[opts.idField]);
}
}
};
_7d6(data,_7d4);
...
_7d5.data=_7d5.data.concat(data);
}
this.sort(_7d3,data);
this.treeNodes=data;
this.treeLevel=$(_7d3).treegrid("getLevel",_7d4);
},sort:function(_7d9,data){
var opts=$.data(_7d9,"treegrid").options;
if(!opts.remoteSort&&opts.sortName){
var _7da=opts.sortName.split(",");
var _7db=opts.sortOrder.split(",");
_7dc(data);
}
function _7dc(rows){
...
var sn=_7da[i];
var so=_7db[i];
var col=$(_7d9).treegrid("getColumnOption",sn);
...
for(var i=0;i<rows.length;i++){
var _7de=rows[i].children;
if(_7de&&_7de.length){
_7dc(_7de);
}
}
};
},transfer:function(_7df,_7e0,data){
...
$.fn.treegrid.defaults=$.extend({},$.fn.datagrid.defaults,{treeField:null,animate:false,singleSelect:true,view:_7ab,loader:function(_7e2,_7e3,_7e4){
var opts=$(this).treegrid("options");
if(!opts.url){
return false;
}
...
},loadFilter:function(data,_7e5){
return data;
},finder:{getTr:function(_7e6,id,type,_7e7){
type=type||"body";
_7e7=_7e7||0;
var dc=$.data(_7e6,"datagrid").dc;
if(_7e7==0){
var opts=$.data(_7e6,"treegrid").options;
var tr1=opts.finder.getTr(_7e6,id,type,1);
var tr2=opts.finder.getTr(_7e6,id,type,2);
return tr1.add(tr2);
}else{
if(type=="body"){
var tr=$("#"+$.data(_7e6,"datagrid").rowIdPrefix+"-"+_7e7+"-"+id);
if(!tr.length){
tr=(_7e7==1?dc.body1:dc.body2).find("tr[node-id=\""+id+"\"]");
}
return tr;
}else{
if(type=="footer"){
return (_7e7==1?dc.footer1:dc.footer2).find("tr[node-id=\""+id+"\"]");
}else{
if(type=="selected"){
return (_7e7==1?dc.body1:dc.body2).find("tr.datagrid-row-selected");
}else{
if(type=="highlight"){
return (_7e7==1?dc.body1:dc.body2).find("tr.datagrid-row-over");
}else{
if(type=="checked"){
return (_7e7==1?dc.body1:dc.body2).find("tr.datagrid-row-checked");
}else{
if(type=="last"){
return (_7e7==1?dc.body1:dc.body2).find("tr:last[node-id]");
}else{
if(type=="allbody"){
return (_7e7==1?dc.body1:dc.body2).find("tr[node-id]");
}else{
if(type=="allfooter"){
return (_7e7==1?dc.footer1:dc.footer2).find("tr[node-id]");
}
}
}
}
...
},getRow:function(_7e8,p){
var id=(typeof p=="object")?p.attr("node-id"):p;
return $(_7e8).treegrid("find",id);
},getRows:function(_7e9){
return $(_7e9).treegrid("getChildren");
}},onBeforeLoad:function(row,_7ea){
...
},onClickCell:function(_7eb,row){
},onDblClickCell:function(_7ec,row){
},onContextMenu:function(e,row){
},onBeforeEdit:function(row){
},onAfterEdit:function(row,_7ed){
},onCancelEdit:function(row){
}});
})(jQuery);
(function($){
function _7ee(_7ef,_7f0){
var _7f1=$.data(_7ef,"combo");
...
_7f2.appendTo("body");
var _7f4=_7f2.find("input.combo-text");
var _7f5=_7f2.find(".combo-arrow");
var _7f6=opts.hasDownArrow?_7f5._outerWidth():0;
_7f2._outerWidth(opts.width)._outerHeight(opts.height);
_7f4._outerWidth(_7f2.width()-_7f6);
_7f4.css({height:_7f2.height()+"px",lineHeight:_7f2.height()+"px"});
_7f5._outerHeight(_7f2.height());
_7f3.panel("resize",{width:(opts.panelWidth?opts.panelWidth:_7f2.outerWidth()),height:opts.panelHeight});
_7f2.insertAfter(_7ef);
};
function init(_7f7){
$(_7f7).addClass("combo-f").hide();
var span=$("<span class=\"combo\">"+"<input type=\"text\" class=\"combo-text\" autocomplete=\"off\">"+"<span><span class=\"combo-arrow\"></span></span>"+"<input type=\"hidden\" class=\"combo-value\">"+"</span>").insertAfter(_7f7);
var _7f8=$("<div class=\"combo-panel\"></div>").appendTo("body");
_7f8.panel({doSize:false,closed:true,cls:"combo-p",style:{position:"absolute",zIndex:10},onOpen:function(){
$(this).panel("resize");
},onClose:function(){
var _7f9=$.data(_7f7,"combo");
if(_7f9){
_7f9.options.onHidePanel.call(_7f7);
}
}});
var name=$(_7f7).attr("name");
if(name){
span.find("input.combo-value").attr("name",name);
$(_7f7).removeAttr("name").attr("comboName",name);
}
return {combo:span,panel:_7f8};
};
function _7fa(_7fb){
var _7fc=$.data(_7fb,"combo");
var opts=_7fc.options;
var _7fd=_7fc.combo;
if(opts.hasDownArrow){
_7fd.find(".combo-arrow").show();
}else{
_7fd.find(".combo-arrow").hide();
}
_7fe(_7fb,opts.disabled);
_7ff(_7fb,opts.readonly);
};
function _800(_801){
var _802=$.data(_801,"combo");
var _803=_802.combo.find("input.combo-text");
_803.validatebox("destroy");
_802.panel.panel("destroy");
_802.combo.remove();
$(_801).remove();
};
function _804(_805){
$(_805).find(".combo-f").each(function(){
...
var _809=_808.panel;
var _80a=_808.combo;
var _80b=_80a.find(".combo-text");
var _80c=_80a.find(".combo-arrow");
...
_80b.bind("click.combo",function(e){
if(!opts.editable){
_80d.call(this);
}else{
var p=$(this).closest("div.combo-panel");
$("div.combo-panel:visible").not(_809).not(p).panel("close");
}
}).bind("keydown.combo",function(e){
switch(e.keyCode){
case 38:
opts.keyHandler.up.call(_807,e);
break;
case 40:
opts.keyHandler.down.call(_807,e);
break;
case 37:
opts.keyHandler.left.call(_807,e);
break;
case 39:
opts.keyHandler.right.call(_807,e);
break;
case 13:
e.preventDefault();
opts.keyHandler.enter.call(_807,e);
return false;
case 9:
case 27:
_80e(_807);
...
if(opts.editable){
if(_808.timer){
clearTimeout(_808.timer);
}
_808.timer=setTimeout(function(){
var q=_80b.val();
if(_808.previousValue!=q){
_808.previousValue=q;
$(_807).combo("showPanel");
opts.keyHandler.query.call(_807,_80b.val(),e);
$(_807).combo("validate");
}
},opts.delay);
}
...
_80c.bind("click.combo",function(){
_80d.call(this);
...
function _80f(_810){
var opts=$.data(_810,"combo").options;
var _811=$.data(_810,"combo").combo;
var _812=$.data(_810,"combo").panel;
if($.fn.window){
_812.panel("panel").css("z-index",$.fn.window.defaults.zIndex++);
}
_812.panel("move",{left:_811.offset().left,top:_813()});
if(_812.panel("options").closed){
_812.panel("open");
opts.onShowPanel.call(_810);
}
(function(){
if(_812.is(":visible")){
_812.panel("move",{left:_814(),top:_813()});
setTimeout(arguments.callee,200);
}
})();
function _814(){
var left=_811.offset().left;
if(left+_812._outerWidth()>$(window)._outerWidth()+$(document).scrollLeft()){
left=$(window)._outerWidth()+$(document).scrollLeft()-_812._outerWidth();
}
if(left<0){
left=0;
}
...
function _813(){
var top=_811.offset().top+_811._outerHeight();
if(top+_812._outerHeight()>$(window)._outerHeight()+$(document).scrollTop()){
top=_811.offset().top-_812._outerHeight();
}
if(top<$(document).scrollTop()){
top=_811.offset().top+_811._outerHeight();
}
return top;
};
};
function _80e(_815){
var _816=$.data(_815,"combo").panel;
_816.panel("close");
};
function _817(_818){
var opts=$.data(_818,"combo").options;
var _819=$(_818).combo("textbox");
_819.validatebox($.extend({},opts,{deltaX:(opts.hasDownArrow?opts.deltaX:(opts.deltaX>0?1:-1))}));
};
function _7fe(_81a,_81b){
var _81c=$.data(_81a,"combo");
var opts=_81c.options;
var _81d=_81c.combo;
if(_81b){
opts.disabled=true;
$(_81a).attr("disabled",true);
_81d.find(".combo-value").attr("disabled",true);
_81d.find(".combo-text").attr("disabled",true);
}else{
opts.disabled=false;
$(_81a).removeAttr("disabled");
_81d.find(".combo-value").removeAttr("disabled");
_81d.find(".combo-text").removeAttr("disabled");
}
};
function _7ff(_81e,mode){
var _81f=$.data(_81e,"combo");
var opts=_81f.options;
opts.readonly=mode==undefined?true:mode;
var _820=opts.readonly?true:(!opts.editable);
_81f.combo.find(".combo-text").attr("readonly",_820).css("cursor",_820?"pointer":"");
};
function _821(_822){
...
var _824=_823.combo;
if(opts.multiple){
_824.find("input.combo-value").remove();
}else{
_824.find("input.combo-value").val("");
}
_824.find("input.combo-text").val("");
};
function _825(_826){
var _827=$.data(_826,"combo").combo;
return _827.find("input.combo-text").val();
};
function _828(_829,text){
var _82a=$.data(_829,"combo");
var _82b=_82a.combo.find("input.combo-text");
if(_82b.val()!=text){
_82b.val(text);
$(_829).combo("validate");
_82a.previousValue=text;
}
};
function _82c(_82d){
var _82e=[];
var _82f=$.data(_82d,"combo").combo;
_82f.find("input.combo-value").each(function(){
_82e.push($(this).val());
});
return _82e;
};
function _830(_831,_832){
var opts=$.data(_831,"combo").options;
var _833=_82c(_831);
var _834=$.data(_831,"combo").combo;
_834.find("input.combo-value").remove();
var name=$(_831).attr("comboName");
for(var i=0;i<_832.length;i++){
var _835=$("<input type=\"hidden\" class=\"combo-value\">").appendTo(_834);
if(name){
_835.attr("name",name);
}
_835.val(_832[i]);
...
if(aa.length!=_832.length||_832.length!=_833.length){
if(opts.multiple){
opts.onChange.call(_831,_832,_833);
}else{
opts.onChange.call(_831,_832[0],_833[0]);
}
}
};
function _836(_837){
...
function _83c(_83d){
var opts=$.data(_83d,"combo").options;
var fn=opts.onChange;
opts.onChange=function(){
};
if(opts.multiple){
...
_830(_83d,opts.value);
}else{
_839(_83d,opts.value);
}
}else{
_830(_83d,[]);
}
opts.originalValue=_82c(_83d);
}else{
_839(_83d,opts.value);
...
$.fn.combo=function(_83e,_83f){
if(typeof _83e=="string"){
var _840=$.fn.combo.methods[_83e];
if(_840){
return _840(this,_83f);
}else{
return this.each(function(){
var _841=$(this).combo("textbox");
_841.validatebox(_83e,_83f);
});
}
}
_83e=_83e||{};
return this.each(function(){
var _842=$.data(this,"combo");
if(_842){
$.extend(_842.options,_83e);
}else{
var r=init(this);
_842=$.data(this,"combo",{options:$.extend({},$.fn.combo.defaults,$.fn.combo.parseOptions(this),_83e),combo:r.combo,panel:r.panel,previousValue:null});
$(this).removeAttr("disabled");
}
_7fa(this);
_7ee(this);
...
var _844=$.data(jq[0],"combo").combo.find("input.combo-text");
return _844.validatebox("isValid");
},clear:function(jq){
return jq.each(function(){
_821(this);
});
...
$.fn.combo.parseOptions=function(_847){
var t=$(_847);
return $.extend({},$.fn.validatebox.parseOptions(_847),$.parser.parseOptions(_847,["width","height","separator",{panelWidth:"number",editable:"boolean",hasDownArrow:"boolean",delay:"number",selectOnNavigation:"boolean"}]),{panelHeight:(t.attr("panelHeight")=="auto"?"auto":parseInt(t.attr("panelHeight"))||undefined),multiple:(t.attr("multiple")?true:undefined),disabled:(t.attr("disabled")?true:undefined),readonly:(t.attr("readonly")?true:undefined),value:(t.val()||undefined)});
};
...
},onChange:function(_848,_849){
}});
})(jQuery);
(function($){
function _84a(_84b,_84c,_84d,_84e){
var _84f=$.data(_84b,"combobox");
var opts=_84f.options;
if(_84e){
return _850(_84f.groups,_84d,_84c);
}else{
return _850(_84f.data,(_84d?_84d:_84f.options.valueField),_84c);
}
function _850(data,key,_851){
for(var i=0;i<data.length;i++){
var row=data[i];
if(row[key]==_851){
return row;
...
var _855=$(_853).combo("panel");
var row=_84a(_853,_854);
if(row){
var item=$("#"+row.domId);
if(item.position().top<=0){
var h=_855.scrollTop()+item.position().top;
_855.scrollTop(h);
}else{
if(item.position().top+item.outerHeight()>_855.height()){
var h=_855.scrollTop()+item.position().top+item.outerHeight()-_855.height();
_855.scrollTop(h);
}
}
}
};
function nav(_856,dir){
var opts=$.data(_856,"combobox").options;
var _857=$(_856).combobox("panel");
var item=_857.children("div.combobox-item-hover");
if(!item.length){
item=_857.children("div.combobox-item-selected");
}
item.removeClass("combobox-item-hover");
var _858="div.combobox-item:visible:not(.combobox-item-disabled):first";
var _859="div.combobox-item:visible:not(.combobox-item-disabled):last";
if(!item.length){
item=_857.children(dir=="next"?_858:_859);
}else{
if(dir=="next"){
item=item.nextAll(_858);
if(!item.length){
item=_857.children(_858);
}
}else{
item=item.prevAll(_858);
if(!item.length){
item=_857.children(_859);
}
}
}
if(item.length){
item.addClass("combobox-item-hover");
var row=_84a(_856,item.attr("id"),"domId");
if(row){
_852(_856,row[opts.valueField]);
if(opts.selectOnNavigation){
_85a(_856,row[opts.valueField]);
}
}
}
};
function _85a(_85b,_85c){
var opts=$.data(_85b,"combobox").options;
var _85d=$(_85b).combo("getValues");
if($.inArray(_85c+"",_85d)==-1){
if(opts.multiple){
_85d.push(_85c);
}else{
_85d=[_85c];
...
_85e(_85b,_85d);
opts.onSelect.call(_85b,_84a(_85b,_85c));
}
};
function _85f(_860,_861){
var opts=$.data(_860,"combobox").options;
var _862=$(_860).combo("getValues");
var _863=$.inArray(_861+"",_862);
if(_863>=0){
_862.splice(_863,1);
_85e(_860,_862);
opts.onUnselect.call(_860,_84a(_860,_861));
}
};
function _85e(_864,_865,_866){
var opts=$.data(_864,"combobox").options;
var _867=$(_864).combo("panel");
_867.find("div.combobox-item-selected").removeClass("combobox-item-selected");
var vv=[],ss=[];
...
$(_864).combo("setValues",vv);
if(!_866){
$(_864).combo("setText",ss.join(opts.separator));
}
};
var _868=1;
function _869(_86a,data,_86b){
var _86c=$.data(_86a,"combobox");
var opts=_86c.options;
_86c.data=opts.loadFilter.call(_86a,data);
_86c.groups=[];
data=_86c.data;
var _86d=$(_86a).combobox("getValues");
var dd=[];
var _86e=undefined;
for(var i=0;i<data.length;i++){
var row=data[i];
...
if(_86e!=g){
_86e=g;
var grow={value:g,domId:("_easyui_combobox_"+_868++)};
_86c.groups.push(grow);
dd.push("<div id=\""+grow.domId+"\" class=\"combobox-group\">");
dd.push(opts.groupFormatter?opts.groupFormatter.call(_86a,g):g);
dd.push("</div>");
}
}else{
_86e=undefined;
...
row.domId="_easyui_combobox_"+_868++;
dd.push("<div id=\""+row.domId+"\" class=\""+cls+"\">");
dd.push(opts.formatter?opts.formatter.call(_86a,row):s);
dd.push("</div>");
if(row["selected"]&&$.inArray(v,_86d)==-1){
_86d.push(v);
}
}
$(_86a).combo("panel").html(dd.join(""));
if(opts.multiple){
_85e(_86a,_86d,_86b);
}else{
_85e(_86a,_86d.length?[_86d[_86d.length-1]]:[],_86b);
}
opts.onLoadSuccess.call(_86a,data);
};
function _86f(_870,url,_871,_872){
var opts=$.data(_870,"combobox").options;
if(url){
opts.url=url;
}
_871=_871||{};
if(opts.onBeforeLoad.call(_870,_871)==false){
return;
}
opts.loader.call(_870,_871,function(data){
_869(_870,data,_872);
},function(){
...
if(opts.mode=="remote"){
_86f(_874,null,{q:q},true);
}else{
var _876=$(_874).combo("panel");
_876.find("div.combobox-item,div.combobox-group").hide();
var data=_875.data;
var _877=undefined;
for(var i=0;i<data.length;i++){
var row=data[i];
if(opts.filter.call(_874,q,row)){
var v=row[opts.valueField];
var s=row[opts.textField];
var g=row[opts.groupField];
...
if(opts.groupField&&_877!=g){
var grow=_84a(_874,g,"value",true);
if(grow){
$("#"+grow.domId).show();
}
_877=g;
...
var _87a=t.combobox("panel");
var item=_87a.children("div.combobox-item-hover");
if(!item.length){
item=_87a.children("div.combobox-item-selected");
}
if(!item.length){
return;
}
var row=_84a(_879,item.attr("id"),"domId");
if(!row){
return;
}
var _87b=row[opts.valueField];
if(opts.multiple){
if(item.hasClass("combobox-item-selected")){
t.combobox("unselect",_87b);
}else{
t.combobox("select",_87b);
}
}else{
t.combobox("select",_87b);
...
function _87d(_87e){
var opts=$.data(_87e,"combobox").options;
$(_87e).addClass("combobox-f");
$(_87e).combo($.extend({},opts,{onShowPanel:function(){
$(_87e).combo("panel").find("div.combobox-item,div.combobox-group").show();
_852(_87e,$(_87e).combobox("getValue"));
opts.onShowPanel.call(_87e);
}}));
$(_87e).combo("panel").unbind().bind("mouseover",function(e){
...
var row=_84a(_87e,item.attr("id"),"domId");
if(!row){
return;
}
...
_85a(_87e,_87f);
$(_87e).combo("hidePanel");
}
e.stopPropagation();
});
};
$.fn.combobox=function(_880,_881){
if(typeof _880=="string"){
var _882=$.fn.combobox.methods[_880];
if(_882){
return _882(this,_881);
}else{
return this.combo(_880,_881);
}
}
_880=_880||{};
return this.each(function(){
var _883=$.data(this,"combobox");
if(_883){
$.extend(_883.options,_880);
_87d(this);
}else{
_883=$.data(this,"combobox",{options:$.extend({},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_880),data:[]});
_87d(this);
...
if(_883.options.data){
_869(this,_883.options.data);
}
_86f(this);
});
};
$.fn.combobox.methods={options:function(jq){
var _884=jq.combo("options");
return $.extend($.data(jq[0],"combobox").options,{originalValue:_884.originalValue,disabled:_884.disabled,readonly:_884.readonly});
},getData:function(jq){
return $.data(jq[0],"combobox").data;
},setValues:function(jq,_885){
return jq.each(function(){
_85e(this,_885);
});
},setValue:function(jq,_886){
return jq.each(function(){
_85e(this,[_886]);
});
},clear:function(jq){
return jq.each(function(){
$(this).combo("clear");
var _887=$(this).combo("panel");
_887.find("div.combobox-item-selected").removeClass("combobox-item-selected");
});
},reset:function(jq){
return jq.each(function(){
...
},select:function(jq,_888){
return jq.each(function(){
_85a(this,_888);
});
},unselect:function(jq,_889){
return jq.each(function(){
_85f(this,_889);
});
}};
$.fn.combobox.parseOptions=function(_88a){
var t=$(_88a);
return $.extend({},$.fn.combo.parseOptions(_88a),$.parser.parseOptions(_88a,["valueField","textField","groupField","mode","method","url"]));
};
$.fn.combobox.parseData=function(_88b){
var data=[];
var opts=$(_88b).combobox("options");
$(_88b).children().each(function(){
if(this.tagName.toLowerCase()=="optgroup"){
var _88c=$(this).attr("label");
...
row[opts.groupField]=_88e;
}
data.push(row);
};
};
$.fn.combobox.defaults=$.extend({},$.fn.combo.defaults,{valueField:"value",textField:"text",groupField:null,groupFormatter:function(_88f){
return _88f;
...
},loader:function(_890,_891,_892){
var opts=$(this).combobox("options");
if(!opts.url){
return false;
}
...
return data;
},onBeforeLoad:function(_893){
},onLoadSuccess:function(){
},onLoadError:function(){
},onSelect:function(_894){
},onUnselect:function(_895){
}});
})(jQuery);
(function($){
function _896(_897){
var opts=$.data(_897,"combotree").options;
var tree=$.data(_897,"combotree").tree;
$(_897).addClass("combotree-f");
$(_897).combo(opts);
var _898=$(_897).combo("panel");
if(!tree){
tree=$("<ul></ul>").appendTo(_898);
$.data(_897,"combotree").tree=tree;
}
tree.tree($.extend({},opts,{checkbox:opts.multiple,onLoadSuccess:function(node,data){
var _899=$(_897).combotree("getValues");
if(opts.multiple){
var _89a=tree.tree("getChecked");
...
$(_897).combotree("setValues",_899);
opts.onLoadSuccess.call(this,node,data);
},onClick:function(node){
_89c(_897);
$(_897).combo("hidePanel");
opts.onClick.call(this,node);
},onCheck:function(node,_89b){
_89c(_897);
opts.onCheck.call(this,node,_89b);
}}));
};
function _89c(_89d){
var opts=$.data(_89d,"combotree").options;
var tree=$.data(_89d,"combotree").tree;
var vv=[],ss=[];
if(opts.multiple){
...
$(_89d).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
function _89f(_8a0,_8a1){
var opts=$.data(_8a0,"combotree").options;
var tree=$.data(_8a0,"combotree").tree;
...
$(_8a0).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
$.fn.combotree=function(_8a2,_8a3){
if(typeof _8a2=="string"){
var _8a4=$.fn.combotree.methods[_8a2];
if(_8a4){
return _8a4(this,_8a3);
}else{
return this.combo(_8a2,_8a3);
}
}
_8a2=_8a2||{};
return this.each(function(){
var _8a5=$.data(this,"combotree");
if(_8a5){
$.extend(_8a5.options,_8a2);
}else{
$.data(this,"combotree",{options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_8a2)});
}
_896(this);
});
};
$.fn.combotree.methods={options:function(jq){
var _8a6=jq.combo("options");
return $.extend($.data(jq[0],"combotree").options,{originalValue:_8a6.originalValue,disabled:_8a6.disabled,readonly:_8a6.readonly});
},tree:function(jq){
...
$.fn.combotree.parseOptions=function(_8a9){
return $.extend({},$.fn.combo.parseOptions(_8a9),$.fn.tree.parseOptions(_8a9));
};
$.fn.combotree.defaults=$.extend({},$.fn.combo.defaults,$.fn.tree.defaults,{editable:false});
})(jQuery);
(function($){
function _8aa(_8ab){
var _8ac=$.data(_8ab,"combogrid");
var opts=_8ac.options;
var grid=_8ac.grid;
$(_8ab).addClass("combogrid-f").combo(opts);
var _8ad=$(_8ab).combo("panel");
if(!grid){
grid=$("<table></table>").appendTo(_8ad);
_8ac.grid=grid;
}
grid.datagrid($.extend({},opts,{border:false,fit:true,singleSelect:(!opts.multiple),onLoadSuccess:function(data){
var _8ae=$(_8ab).combo("getValues");
var _8af=opts.onSelect;
opts.onSelect=function(){
};
_8b9(_8ab,_8ae,_8ac.remainText);
opts.onSelect=_8af;
opts.onLoadSuccess.apply(_8ab,arguments);
},onClickRow:_8b0,onSelect:function(_8b1,row){
_8b2();
opts.onSelect.call(this,_8b1,row);
},onUnselect:function(_8b3,row){
_8b2();
opts.onUnselect.call(this,_8b3,row);
},onSelectAll:function(rows){
_8b2();
...
function _8b0(_8b4,row){
_8ac.remainText=false;
_8b2();
if(!opts.multiple){
$(_8ab).combo("hidePanel");
}
opts.onClickRow.call(this,_8b4,row);
};
function _8b2(){
...
if(!opts.multiple){
$(_8ab).combo("setValues",(vv.length?vv:[""]));
}else{
$(_8ab).combo("setValues",vv);
}
if(!_8ac.remainText){
$(_8ab).combo("setText",ss.join(opts.separator));
}
};
};
function nav(_8b5,dir){
var _8b6=$.data(_8b5,"combogrid");
var opts=_8b6.options;
var grid=_8b6.grid;
var _8b7=grid.datagrid("getRows").length;
if(!_8b7){
return;
}
...
var _8b8;
if(!tr.length){
_8b8=(dir=="next"?0:_8b7-1);
}else{
var _8b8=parseInt(tr.attr("datagrid-row-index"));
_8b8+=(dir=="next"?1:-1);
if(_8b8<0){
_8b8=_8b7-1;
}
...
grid.datagrid("highlightRow",_8b8);
if(opts.selectOnNavigation){
_8b6.remainText=false;
grid.datagrid("selectRow",_8b8);
}
};
function _8b9(_8ba,_8bb,_8bc){
var _8bd=$.data(_8ba,"combogrid");
var opts=_8bd.options;
var grid=_8bd.grid;
var rows=grid.datagrid("getRows");
var ss=[];
var _8be=$(_8ba).combo("getValues");
var _8bf=$(_8ba).combo("options");
var _8c0=_8bf.onChange;
_8bf.onChange=function(){
};
grid.datagrid("clearSelections");
for(var i=0;i<_8bb.length;i++){
var _8c1=grid.datagrid("getRowIndex",_8bb[i]);
if(_8c1>=0){
grid.datagrid("selectRow",_8c1);
ss.push(rows[_8c1][opts.textField]);
}else{
ss.push(_8bb[i]);
}
}
$(_8ba).combo("setValues",_8be);
_8bf.onChange=_8c0;
$(_8ba).combo("setValues",_8bb);
if(!_8bc){
var s=ss.join(opts.separator);
if($(_8ba).combo("getText")!=s){
$(_8ba).combo("setText",s);
}
}
};
function _8c2(_8c3,q){
var _8c4=$.data(_8c3,"combogrid");
var opts=_8c4.options;
var grid=_8c4.grid;
_8c4.remainText=true;
if(opts.multiple&&!q){
_8b9(_8c3,[],true);
}else{
_8b9(_8c3,[q],true);
...
var rows=grid.datagrid("getRows");
for(var i=0;i<rows.length;i++){
if(opts.filter.call(_8c3,q,rows[i])){
grid.datagrid("clearSelections");
...
_8c7.remainText=false;
var _8c8=parseInt(tr.attr("datagrid-row-index"));
if(opts.multiple){
if(tr.hasClass("datagrid-row-selected")){
grid.datagrid("unselectRow",_8c8);
}else{
grid.datagrid("selectRow",_8c8);
}
}else{
grid.datagrid("selectRow",_8c8);
$(_8c6).combogrid("hidePanel");
}
};
$.fn.combogrid=function(_8c9,_8ca){
if(typeof _8c9=="string"){
var _8cb=$.fn.combogrid.methods[_8c9];
if(_8cb){
return _8cb(this,_8ca);
}else{
return this.combo(_8c9,_8ca);
}
}
_8c9=_8c9||{};
return this.each(function(){
var _8cc=$.data(this,"combogrid");
if(_8cc){
$.extend(_8cc.options,_8c9);
}else{
_8cc=$.data(this,"combogrid",{options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_8c9)});
}
_8aa(this);
});
};
$.fn.combogrid.methods={options:function(jq){
var _8cd=jq.combo("options");
return $.extend($.data(jq[0],"combogrid").options,{originalValue:_8cd.originalValue,disabled:_8cd.disabled,readonly:_8cd.readonly});
},grid:function(jq){
return $.data(jq[0],"combogrid").grid;
},setValues:function(jq,_8ce){
return jq.each(function(){
_8b9(this,_8ce);
});
},setValue:function(jq,_8cf){
return jq.each(function(){
_8b9(this,[_8cf]);
});
},clear:function(jq){
...
$.fn.combogrid.parseOptions=function(_8d0){
var t=$(_8d0);
return $.extend({},$.fn.combo.parseOptions(_8d0),$.fn.datagrid.parseOptions(_8d0),$.parser.parseOptions(_8d0,["idField","textField","mode"]));
};
...
(function($){
function _8d1(_8d2){
var _8d3=$.data(_8d2,"datebox");
var opts=_8d3.options;
$(_8d2).addClass("datebox-f").combo($.extend({},opts,{onShowPanel:function(){
_8d4();
_8dc(_8d2,$(_8d2).datebox("getText"));
opts.onShowPanel.call(_8d2);
}}));
$(_8d2).combo("textbox").parent().addClass("datebox");
if(!_8d3.calendar){
_8d5();
}
function _8d5(){
var _8d6=$(_8d2).combo("panel").css("overflow","hidden");
var cc=$("<div class=\"datebox-calendar-inner\"></div>").appendTo(_8d6);
if(opts.sharedCalendar){
_8d3.calendar=$(opts.sharedCalendar).appendTo(cc);
if(!_8d3.calendar.hasClass("calendar")){
_8d3.calendar.calendar();
}
}else{
_8d3.calendar=$("<div></div>").appendTo(cc).calendar();
}
$.extend(_8d3.calendar.calendar("options"),{fit:true,border:false,onSelect:function(date){
var opts=$(this.target).datebox("options");
_8dc(this.target,opts.formatter(date));
$(this.target).combo("hidePanel");
opts.onSelect.call(_8d2,date);
}});
_8dc(_8d2,opts.value);
var _8d7=$("<div class=\"datebox-button\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"width:100%\"><tr></tr></table></div>").appendTo(_8d6);
var tr=_8d7.find("tr");
for(var i=0;i<opts.buttons.length;i++){
var td=$("<td></td>").appendTo(tr);
var btn=opts.buttons[i];
var t=$("<a href=\"javascript:void(0)\"></a>").html($.isFunction(btn.text)?btn.text(_8d2):btn.text).appendTo(td);
t.bind("click",{target:_8d2,handler:btn.handler},function(e){
...
function _8d4(){
var _8d8=$(_8d2).combo("panel");
var cc=_8d8.children("div.datebox-calendar-inner");
_8d8.children()._outerWidth(_8d8.width());
_8d3.calendar.appendTo(cc);
_8d3.calendar[0].target=_8d2;
if(opts.panelHeight!="auto"){
var _8d9=_8d8.height();
_8d8.children().not(cc).each(function(){
_8d9-=$(this).outerHeight();
});
cc._outerHeight(_8d9);
}
_8d3.calendar.calendar("resize");
};
};
function _8da(_8db,q){
_8dc(_8db,q);
};
function _8dd(_8de){
var _8df=$.data(_8de,"datebox");
var opts=_8df.options;
var _8e0=opts.formatter(_8df.calendar.calendar("options").current);
_8dc(_8de,_8e0);
$(_8de).combo("hidePanel");
};
function _8dc(_8e1,_8e2){
var _8e3=$.data(_8e1,"datebox");
var opts=_8e3.options;
$(_8e1).combo("setValue",_8e2).combo("setText",_8e2);
_8e3.calendar.calendar("moveTo",opts.parser(_8e2));
};
$.fn.datebox=function(_8e4,_8e5){
if(typeof _8e4=="string"){
var _8e6=$.fn.datebox.methods[_8e4];
if(_8e6){
return _8e6(this,_8e5);
}else{
return this.combo(_8e4,_8e5);
}
}
_8e4=_8e4||{};
return this.each(function(){
var _8e7=$.data(this,"datebox");
if(_8e7){
$.extend(_8e7.options,_8e4);
}else{
$.data(this,"datebox",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_8e4)});
}
_8d1(this);
});
};
$.fn.datebox.methods={options:function(jq){
var _8e8=jq.combo("options");
return $.extend($.data(jq[0],"datebox").options,{originalValue:_8e8.originalValue,disabled:_8e8.disabled,readonly:_8e8.readonly});
...
$.fn.datebox.parseOptions=function(_8ea){
return $.extend({},$.fn.combo.parseOptions(_8ea),$.parser.parseOptions(_8ea,["sharedCalendar"]));
};
...
_8da(this,q);
}},currentText:"Today",closeText:"Close",okText:"Ok",buttons:[{text:function(_8eb){
return $(_8eb).datebox("options").currentText;
},handler:function(_8ec){
$(_8ec).datebox("calendar").calendar({year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date()});
_8dd(_8ec);
}},{text:function(_8ed){
return $(_8ed).datebox("options").closeText;
},handler:function(_8ee){
...
(function($){
function _8ef(_8f0){
var _8f1=$.data(_8f0,"datetimebox");
var opts=_8f1.options;
$(_8f0).datebox($.extend({},opts,{onShowPanel:function(){
var _8f2=$(_8f0).datetimebox("getValue");
_8f4(_8f0,_8f2,true);
opts.onShowPanel.call(_8f0);
},formatter:$.fn.datebox.defaults.formatter,parser:$.fn.datebox.defaults.parser}));
$(_8f0).removeClass("datebox-f").addClass("datetimebox-f");
$(_8f0).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(_8f0,date);
}});
var _8f3=$(_8f0).datebox("panel");
if(!_8f1.spinner){
var p=$("<div style=\"padding:2px\"><input style=\"width:80px\"></div>").insertAfter(_8f3.children("div.datebox-calendar-inner"));
_8f1.spinner=p.children("input");
}
_8f1.spinner.timespinner({showSeconds:opts.showSeconds,separator:opts.timeSeparator}).unbind(".datetimebox").bind("mousedown.datetimebox",function(e){
e.stopPropagation();
});
_8f4(_8f0,opts.value);
};
function _8f5(_8f6){
var c=$(_8f6).datetimebox("calendar");
var t=$(_8f6).datetimebox("spinner");
var date=c.calendar("options").current;
return new Date(date.getFullYear(),date.getMonth(),date.getDate(),t.timespinner("getHours"),t.timespinner("getMinutes"),t.timespinner("getSeconds"));
};
function _8f7(_8f8,q){
_8f4(_8f8,q,true);
};
function _8f9(_8fa){
var opts=$.data(_8fa,"datetimebox").options;
var date=_8f5(_8fa);
_8f4(_8fa,opts.formatter.call(_8fa,date));
$(_8fa).combo("hidePanel");
};
function _8f4(_8fb,_8fc,_8fd){
var opts=$.data(_8fb,"datetimebox").options;
$(_8fb).combo("setValue",_8fc);
if(!_8fd){
if(_8fc){
var date=opts.parser.call(_8fb,_8fc);
$(_8fb).combo("setValue",opts.formatter.call(_8fb,date));
$(_8fb).combo("setText",opts.formatter.call(_8fb,date));
}else{
$(_8fb).combo("setText",_8fc);
}
}
var date=opts.parser.call(_8fb,_8fc);
$(_8fb).datetimebox("calendar").calendar("moveTo",date);
$(_8fb).datetimebox("spinner").timespinner("setValue",_8fe(date));
function _8fe(date){
function _8ff(_900){
return (_900<10?"0":"")+_900;
};
var tt=[_8ff(date.getHours()),_8ff(date.getMinutes())];
if(opts.showSeconds){
tt.push(_8ff(date.getSeconds()));
}
return tt.join($(_8fb).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_901,_902){
if(typeof _901=="string"){
var _903=$.fn.datetimebox.methods[_901];
if(_903){
return _903(this,_902);
}else{
return this.datebox(_901,_902);
}
}
_901=_901||{};
return this.each(function(){
var _904=$.data(this,"datetimebox");
if(_904){
$.extend(_904.options,_901);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_901)});
}
_8ef(this);
});
};
$.fn.datetimebox.methods={options:function(jq){
var _905=jq.datebox("options");
return $.extend($.data(jq[0],"datetimebox").options,{originalValue:_905.originalValue,disabled:_905.disabled,readonly:_905.readonly});
},spinner:function(jq){
...
$.fn.datetimebox.parseOptions=function(_907){
var t=$(_907);
return $.extend({},$.fn.datebox.parseOptions(_907),$.parser.parseOptions(_907,["timeSeparator",{showSeconds:"boolean"}]));
};
...
_8f7(this,q);
}},buttons:[{text:function(_908){
return $(_908).datetimebox("options").currentText;
},handler:function(_909){
$(_909).datetimebox("calendar").calendar({year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date()});
_8f9(_909);
}},{text:function(_90a){
return $(_90a).datetimebox("options").okText;
},handler:function(_90b){
_8f9(_90b);
}},{text:function(_90c){
return $(_90c).datetimebox("options").closeText;
...
function _90e(_90f){
return (_90f<10?"0":"")+_90f;
};
var _910=$(this).datetimebox("spinner").timespinner("options").separator;
var r=$.fn.datebox.defaults.formatter(date)+" "+_90e(h)+_910+_90e(M);
...
var _911=$(this).datetimebox("spinner").timespinner("options").separator;
var tt=dt[1].split(_911);
var hour=parseInt(tt[0],10)||0;
var _912=parseInt(tt[1],10)||0;
var _913=parseInt(tt[2],10)||0;
return new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_912,_913);
}});
})(jQuery);
(function($){
function init(_914){
var _915=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_914);
var t=$(_914);
t.addClass("slider-f").hide();
var name=t.attr("name");
if(name){
_915.find("input.slider-value").attr("name",name);
t.removeAttr("name").attr("sliderName",name);
}
return _915;
};
function _916(_917,_918){
var _919=$.data(_917,"slider");
var opts=_919.options;
var _91a=_919.slider;
if(_918){
if(_918.width){
...
if(opts.mode=="h"){
_91a.css("height","");
_91a.children("div").css("height","");
if(!isNaN(opts.width)){
_91a.width(opts.width);
}
}else{
_91a.css("width","");
_91a.children("div").css("width","");
if(!isNaN(opts.height)){
_91a.height(opts.height);
_91a.find("div.slider-rule").height(opts.height);
_91a.find("div.slider-rulelabel").height(opts.height);
_91a.find("div.slider-inner")._outerHeight(opts.height);
}
}
_91b(_917);
};
function _91c(_91d){
var _91e=$.data(_91d,"slider");
var opts=_91e.options;
var _91f=_91e.slider;
...
_920(aa);
function _920(aa){
var rule=_91f.find("div.slider-rule");
var _921=_91f.find("div.slider-rulelabel");
rule.empty();
_921.empty();
for(var i=0;i<aa.length;i++){
var _922=i*100/(aa.length-1)+"%";
var span=$("<span></span>").appendTo(rule);
span.css((opts.mode=="h"?"left":"top"),_922);
if(aa[i]!="|"){
span=$("<span></span>").appendTo(_921);
span.html(aa[i]);
if(opts.mode=="h"){
span.css({left:_922,marginLeft:-Math.round(span.outerWidth()/2)});
}else{
span.css({top:_922,marginTop:-Math.round(span.outerHeight()/2)});
}
}
}
};
...
function _923(_924){
var _925=$.data(_924,"slider");
var opts=_925.options;
var _926=_925.slider;
_926.removeClass("slider-h slider-v slider-disabled");
_926.addClass(opts.mode=="h"?"slider-h":"slider-v");
_926.addClass(opts.disabled?"slider-disabled":"");
_926.find("a.slider-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
var _928=_93a(_924,left);
_929(_928);
return false;
}
},onBeforeDrag:function(){
_925.isDragging=true;
},onStartDrag:function(){
opts.onSlideStart.call(_924,opts.value);
},onStopDrag:function(e){
var _92a=_93a(_924,(opts.mode=="h"?e.data.left:e.data.top));
_929(_92a);
opts.onSlideEnd.call(_924,opts.value);
opts.onComplete.call(_924,opts.value);
_925.isDragging=false;
}});
_926.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",function(e){
if(_925.isDragging){
return;
}
var pos=$(this).offset();
var _92b=_93a(_924,(opts.mode=="h"?(e.pageX-pos.left):(e.pageY-pos.top)));
_929(_92b);
opts.onComplete.call(_924,opts.value);
});
function _929(_92c){
var s=Math.abs(_92c%opts.step);
if(s<opts.step/2){
_92c-=s;
}else{
_92c=_92c-s+opts.step;
}
_92d(_924,_92c);
};
};
function _92d(_92e,_92f){
var _930=$.data(_92e,"slider");
...
opts.value=_92f;
$(_92e).val(_92f);
_931.find("input.slider-value").val(_92f);
var pos=_933(_92e,_92f);
var tip=_931.find(".slider-tip");
if(opts.showTip){
tip.show();
tip.html(opts.tipFormatter.call(_92e,opts.value));
}else{
tip.hide();
}
if(opts.mode=="h"){
var _934="left:"+pos+"px;";
_931.find(".slider-handle").attr("style",_934);
tip.attr("style",_934+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _934="top:"+pos+"px;";
_931.find(".slider-handle").attr("style",_934);
tip.attr("style",_934+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
if(_932!=_92f){
opts.onChange.call(_92e,_92f,_932);
}
};
function _91b(_935){
var opts=$.data(_935,"slider").options;
var fn=opts.onChange;
opts.onChange=function(){
};
_92d(_935,opts.value);
opts.onChange=fn;
};
function _933(_936,_937){
var _938=$.data(_936,"slider");
var opts=_938.options;
var _939=_938.slider;
if(opts.mode=="h"){
var pos=(_937-opts.min)/(opts.max-opts.min)*_939.width();
if(opts.reversed){
pos=_939.width()-pos;
}
}else{
var pos=_939.height()-(_937-opts.min)/(opts.max-opts.min)*_939.height();
if(opts.reversed){
pos=_939.height()-pos;
}
}
...
function _93a(_93b,pos){
var _93c=$.data(_93b,"slider");
var opts=_93c.options;
var _93d=_93c.slider;
if(opts.mode=="h"){
var _93e=opts.min+(opts.max-opts.min)*(pos/_93d.width());
}else{
var _93e=opts.min+(opts.max-opts.min)*((_93d.height()-pos)/_93d.height());
}
return opts.reversed?opts.max-_93e.toFixed(0):_93e.toFixed(0);
};
$.fn.slider=function(_93f,_940){
if(typeof _93f=="string"){
return $.fn.slider.methods[_93f](this,_940);
}
_93f=_93f||{};
return this.each(function(){
var _941=$.data(this,"slider");
if(_941){
$.extend(_941.options,_93f);
}else{
_941=$.data(this,"slider",{options:$.extend({},$.fn.slider.defaults,$.fn.slider.parseOptions(this),_93f),slider:init(this)});
$(this).removeAttr("disabled");
}
...
$.fn.slider.parseOptions=function(_944){
var t=$(_944);
return $.extend({},$.parser.parseOptions(_944,["width","height","mode",{reversed:"boolean",showTip:"boolean",min:"number",max:"number",step:"number"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined),rule:(t.attr("rule")?eval(t.attr("rule")):undefined)});
};
$.fn.slider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,value:0,min:0,max:100,step:1,rule:[],tipFormatter:function(_945){
return _945;
},onChange:function(_946,_947){
},onSlideStart:function(_948){
},onSlideEnd:function(_949){
},onComplete:function(_94a){
}};
})(jQuery);
